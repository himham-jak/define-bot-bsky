 ...
 */
export declare class RecordWithMediaEmbed extends PostEmbed {
    record: EmbeddableRecord;
    media: ImagesEmbed | VideoEmbed | ExternalEmbed;
    /**
     * @param record The embedded post record.
     * @param media The media within this embed.
     */
    constructor(record: EmbeddableRecord, media: ImagesEmbed | VideoEmbed | ExternalEmbed);
     ...
     */
    static fromView(view: AppBskyEmbedRecordWithMedia.View, record: AppBskyEmbedRecordWithMedia.Main, bot: Bot): RecordWithMediaEmbed;
}
